              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                     <a href="{{url('reportes/hoy')}}" target="_blank"><i class="fas fa-person-booth fa-2x text-primary"></i></a>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{url('reportes/mes')}}" target="_blank"><i class="fas fa-user-friends fa-2x text-success"></i></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{url('reportes/todos')}}" target="_blank"><i class="fas fa-users fa-2x text-info"></i> </a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{url('reportes/nulos')}}" target="_blank"> <i class="fas fa-ban fa-2x text-danger"></i> </a>
                    </div>
                  </div>
                </div>
              </div>
